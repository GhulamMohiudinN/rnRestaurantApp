    ...
    return (
        <View className='bg-white flex-1 '>
            ...
            <View className='relative py-4 shadow-sm'>
                ...
                <View className={`${Platform.OS === 'ios' ? 'top-0.5' : 'top-4'}`}>
                    <Text className='text-center font-bold text-xl '>Your cart</Text>
                    <Text className='text-center text-gray-500'> {restaurant ? restaurant.name : 'No restaurant selected'}</Text>
                </View>
            </View>
            ...
            <View style={{ backgroundColor: themeColors.bgColor(0.2) }}
                ...
                <Image source={require('../assets/images/delivery-guy.jpg')} className='w-20 h-20 rounded-full ' />
            ...
            <ScrollView
                ...
                className='bg-white pt-5'>
                {
                    Object.entries(groupedItems).map(([key, items]) => {
                        let dish = items[0];
                        return (
                            <View key={key} className='flex-row items-center space-x-3 py-2 px-4 bg-white rounded-3xl mx-2 mb-3 shadow-md' style={{ elevation: 5 }}>
